...
2. Clone your fork: `git clone https://github.com/YOUR-USERNAME/ai-squad.git`
3. Add the upstream repository: `git remote add upstream https://github.com/portofolio-mager/ai-squad.git`

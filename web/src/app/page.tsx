    ...
    <div className={styles.page}>
      ...
      <main className={styles.main}>
        ...
        <div className={styles.installation}>
          ...
          <div className={styles.codeBlockWrapper}>
            <pre className={styles.codeBlock}>
              <code>curl -fsSL https://raw.githubusercontent.com/stmg-ai/ai-squad/main/install.sh | bash</code>
            </pre>
            <CopyButton textToCopy="curl -fsSL https://raw.githubusercontent.com/stmg-ai/ai-squad/main/install.sh | bash" />
          </div>
      ...
      <footer className={styles.footer}>
        <p className={styles.copyright}>
          &copy; {new Date().getFullYear()} AI Squad. Licensed under <a href="https://github.com/portofolio-mager/ai-squad/blob/main/LICENSE.md" target="_blank" rel="noopener noreferrer">GNU AGPL v3.0</a>
        </p>
      </footer>
    </div>
  );

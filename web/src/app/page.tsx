  ...
  return (
    <div className={styles.page}>
      <header className={styles.header}>
        <h1 className={styles.title}>AI Squad</h1>
        <div className={styles.headerActions}>
          <a
            className={styles.headerButton}
            href="https://github.com/portofolio-mager/ai-squad"
            target="_blank"
          ...
          <a
            href="https://github.com/portofolio-mager/ai-squad#readme"
            target="_blank"
            rel="noopener noreferrer"
            className={styles.headerButton}
          >
      ...
      <main className={styles.main}>
        ...
        <div className={styles.installation}>
          ...
          <div className={styles.codeBlockWrapper}>
            ...
            <CopyButton textToCopy="brew install ai-squad" />
          </div>
          <br></br>
          <h3>Via Shell Script</h3>
          <div className={styles.codeBlockWrapper}>
            <pre className={styles.codeBlock}>
              <code>curl -fsSL https://raw.githubusercontent.com/portofolio-mager/ai-squad/dev/install.sh | bash</code>
            </pre>
            <CopyButton textToCopy="curl -fsSL https://raw.githubusercontent.com/portofolio-mager/ai-squad/dev/install.sh | bash" />
          </div>
      ...
      <footer className={styles.footer}>
        <p className={styles.copyright}>
          &copy; {new Date().getFullYear()} AI Squad. Licensed under <a href="https://github.com/portofolio-mager/ai-squad/blob/dev/LICENSE.md" target="_blank" rel="noopener noreferrer">GNU AGPL v3.0</a>
        </p>
      </footer>
    </div>
  );
